...
export default function CardProduct({ src, title, description, price }: ICardProduct) {
  return (
    <article tabIndex={0} className="bg-green-500 w-44 h-60 m-2 relative flex flex-col items-center text-center justify-center  rounded-lg shadow-md hover:scale-105 hover:shadow-xl transition-transform cursor-pointer">
      <div className="z-20">
